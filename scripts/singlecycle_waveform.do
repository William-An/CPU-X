...
add wave -noupdate -group DATAPAT -group decif /tb_system/dut/dp0/decif0/dec_exception_event
add wave -noupdate -group DATAPAT -group decif /tb_system/dut/dp0/decif0/dmem_cmd
...
add wave -noupdate -group REGFILE /tb_system/dut/dp0/rf0/rf
add wave -noupdate -group REGFILE /tb_system/dut/dp0/rf0/next_rf
add wave -noupdate -group PC /tb_system/dut/dp0/pc0/tmp_pc
add wave -noupdate -group CSR_EXCEP /tb_system/dut/dp0/csr_exception0/csr
...
WaveRestoreCursors {{Cursor 1} {191929 ps} 0}
...
update
WaveRestoreZoom {0 ps} {349806 ps}
